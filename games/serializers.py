...
class GameSerializer(DynamicFieldsModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["current_turn", "status", "winner", "moves", "board_state"]

    def get_board_matrix(self, obj):
        """Convierte el estado del tablero (cadena de 9 caracteres) en una matriz 3x3 para facilitar su representación en la API."""
